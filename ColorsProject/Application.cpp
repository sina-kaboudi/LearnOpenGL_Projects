...
int main()
{
    ...
    // ------------------------------------
    Shader lightingShader("3.3.vertexShader.vs", "3.3.fragmentShader.fs");
    ...
    // world space positions of our point lights
    ...
    // pre-render shader configuration
    // --------------------
    lightingShader.use();
